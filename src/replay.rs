...
//! embedder's domain, not this crate's: tango's replay container writes
//! its own header/state/metadata and hands this module the sink for the
//! input records that follow.
//!
